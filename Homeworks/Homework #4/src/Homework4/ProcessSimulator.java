...
public class ProcessSimulator extends Thread implements ListenerThread, Simulator
{
    ...
    public volatile static boolean disableGraphicUpdates = false;
    ...
    private void lockVariable()
    {
        ...
        while(!processQueue.isEmpty() && !endThread)
        {
            ...
            if(selectRow && simulationSpeed != 0)
            {
            ...
            processQueue.remove();
            if(!disableGraphicUpdates && simulationSpeed != 0)
                Platform.runLater(() ->
                ...
                if(i == jobs.length - 1 && jobs[i] == 0)
                {
                    ...
                    if(disableGraphicUpdates || simulationSpeed == 0)
                    {
                        Platform.runLater(() ->
                        {
                            ...
                            //Main.addProcessToChart(Integer.parseInt(process.getProcessID()));
                        });
                    }
                }
